...
function promptForEditOrDelete() {
    rl.question('Do you want to edit or delete a contact? (edit/delete/exit): ', function (answer) {
...
function promptForDelete() {
    rl.question('Enter first name of the contact you want to delete: ', function (firstName) {
        rl.question('Enter last name of the contact you want to delete: ', function (lastName) {
