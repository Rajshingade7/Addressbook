...
var AddressBookSystem = /** @class */ (function () {
    ...
    AddressBookSystem.prototype.viewPersonsByCity = function (city) {
        ...
        if (persons) {
            ...
            persons.forEach(function (person) { return console.log("".concat(person.firstName, " ").concat(person.lastName)); });
        }
        else {
...
function promptForAction() {
    rl.question('Do you want to add a new address book, add a new contact, view contacts, search contacts, view persons by city, view persons by state, or exit? (addbook/add/view/search/viewcity/viewstate/exit): ', function (answer) {
