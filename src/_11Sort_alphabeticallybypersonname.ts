...
function promptForAction() {
    rl.question('Do you want to add a new address book, add a new contact, view contacts, search contacts, view persons by city, view persons by state, sort contacts by name, or exit? (addbook/add/view/search/viewcity/viewstate/sort/exit): ', (answer) => {
